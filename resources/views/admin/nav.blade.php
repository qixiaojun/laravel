                        ...
                        <div class="toolbar-menu-administration">
                            <ul class="toolbar-menu root">
                                ...
                                <li class="menu-item level-1">
                                    <div class="toolbar-box">
                                        <a href="/admin/help" title="使用参考、配置和模块。" id="toolbar-link-help-main" class="toolbar-icon toolbar-icon-help-main" data-drupal-link-system-path="admin/help">帮助</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
