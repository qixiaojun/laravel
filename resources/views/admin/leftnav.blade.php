<div id="toolbar-administration" role="group" aria-label="站点管理工具栏" class="toolbar toolbar-oriented">
    <nav class="toolbar-lining clearfix" role="navigation" aria-label="管理菜单(下拉)">
        ...
        <div class="toolbar-tab">
            {{--<a href="/admin" title="管理菜单" class="toolbar-icon toolbar-icon-menu trigger toolbar-item is-active" data-drupal-subtrees="" id="toolbar-item-administration" data-toolbar-tray="toolbar-item-administration-tray" aria-owns="toolbar-item-administration-tray" role="button" aria-pressed="false">管理</a>--}}
            <div id="toolbar-item-administration-tray" data-toolbar-tray="toolbar-item-administration-tray" class="toolbar-tray is-active toolbar-tray-vertical" data-offset-left="" style="margin-top: 39px;">
                <nav class="toolbar-lining clearfix" role="navigation" aria-label="管理菜单(下拉)">
                    <h3 class="toolbar-tray-name visually-hidden">管理菜单(下拉)</h3>
                    <div class="toolbar-menu-administration">
                        <ul class="toolbar-menu root">
                            ...
                            <li class="menu-item menu-item--collapsed level-1">
                                <div class="toolbar-box">
                                <a href="/admin/structure" target="main" title="管理区块、内容类型、菜单等。" id="toolbar-link-system-admin_structure" class="toolbar-icon toolbar-icon-system-admin-structure" data-drupal-link-system-path="admin/structure">结构</a><button class="toolbar-icon toolbar-handle"><span class="action">扩展</span><span class="label">结构</span></button></div>
                                <ul class="toolbar-menu">
                                    <li class="menu-item level-2">
                                    ...
                                    <li class="menu-item level-2">
                                        <div class="toolbar-box"><a href="/admin/structure/block" title="设置区块内容出现在网站的边栏或其他位置。" id="toolbar-link-block-admin_display" class="toolbar-icon toolbar-icon-block-admin-display" data-drupal-link-system-path="admin/structure/block">区块布局</a></div>
                                    </li>
                            ...
                            <li class="menu-item level-1">
                                <div class="toolbar-box">
                                <a href="/admin/appearance" target="main" title="Select and configure themes." id="toolbar-link-system-themes_page" class="toolbar-icon toolbar-icon-system-themes-page" data-drupal-link-system-path="admin/appearance">外观</a></div></li><li class="menu-item level-1"><div class="toolbar-box">
                                    <a href="/admin/modules" target="main" title="添加和启用模块扩展站点的功能。" id="toolbar-link-system-modules_list" class="toolbar-icon toolbar-icon-system-modules-list" data-drupal-link-system-path="admin/modules">扩展</a></div></li><li class="menu-item menu-item--collapsed level-1"><div class="toolbar-box">
                                    <a href="/admin/config" target="main" title="管理设置." id="toolbar-link-system-admin_config" class="toolbar-icon toolbar-icon-system-admin-config" data-drupal-link-system-path="admin/config">配置</a><button class="toolbar-icon toolbar-handle"><span class="action">扩展</span><span class="label">配置</span></button></div>
                                <ul class="toolbar-menu">
                                    <li class="menu-item menu-item--expanded level-2">
                            ...
                            <li class="menu-item level-1"><div class="toolbar-box">
                                <a href="/admin/people" target="main" title="管理用户账号、角色和权限。" id="toolbar-link-entity-user-collection" class="toolbar-icon toolbar-icon-entity-user-collection" data-drupal-link-system-path="admin/people">人员</a></div></li><li class="menu-item menu-item--collapsed level-1">
                                <div class="toolbar-box">
                                    <a href="/admin/reports" target="main" title="查看报告、更新和错误。" id="toolbar-link-system-admin_reports" class="toolbar-icon toolbar-icon-system-admin-reports" data-drupal-link-system-path="admin/reports">报告</a><button class="toolbar-icon toolbar-handle"><span class="action">扩展</span><span class="label">报告</span></button></div>
                                <ul class="toolbar-menu">
                                    <li class="menu-item level-2">
                            ...
                            <li class="menu-item level-1">
                                <div class="toolbar-box">
                                    <a href="/admin/help" target="main" title="使用参考、配置和模块。" id="toolbar-link-help-main" class="toolbar-icon toolbar-icon-help-main" data-drupal-link-system-path="admin/help">帮助</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="toolbar-toggle-orientation" style="">
                        <div class="toolbar-lining">
                            <button class="toolbar-icon toolbar-icon-toggle-horizontal" type="button" value="horizontal" title="水平方向">水平方向</button>
                        </div>
                    </div>
                </nav>
            </div>
